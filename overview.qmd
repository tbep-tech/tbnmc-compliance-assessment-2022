...
<center><h1 style="font-size:180%">`r params$maxyr` Tampa Bay Estuary Nutrient Management Compliance Assessment</h1></center>
...
NMC actions outlined in @fig-decision and Table \@ref(tab:steps) performed during RA Implementation Period (2022-2026) are as follows:
